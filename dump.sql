...
(4, '2020_04_06_084531_create_routes_table', 1);
...
INSERT INTO `routes` (`id`, `from_place_id`, `to_place_id`, `hash`, `number`) VALUES
(1, 1, 2, '1', 2),
(2, 5, 1, '5,3,2', 1);
...
(1, 'admin', '$2y$10$fHLtQM/uSrQCtW4l7X1OFuqCs81XoKLe38JzmS0uT8Shy3MXzPeoG', '21232f297a57a5a743894a0e4a801fc3', 1),
(2, 'user1', '$2y$10$2HpycNZfPDSGvZsbjdXZCOXgax6KoBVdv.L4BpbbRdbx5qLPB7LRS', NULL, 0),
(3, 'user2', '$2y$10$6C6Mt/E6Nafgd0GTPy0Rgef/SklwySTNxGnLJKyAVeuoTCmBxBPNa', NULL, 0);
...
ALTER TABLE `routes`
  ADD CONSTRAINT `routes_from_place_id_foreign` FOREIGN KEY (`from_place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `routes_to_place_id_foreign` FOREIGN KEY (`to_place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE;
COMMIT;
